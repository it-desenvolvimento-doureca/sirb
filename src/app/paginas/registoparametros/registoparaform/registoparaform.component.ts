...
>>>>>>> aa167a7d63b9fa01b26efb1fceaeb7aed3e4b2ea
            ...
            this.param_incorreto_2 = response[x][0].param_INCORRETO_2;
            this.param_incorreto_3 = response[x][0].param_INCORRETO_3;
            this.seguimento = response[x][0].seguimento;
            this.valor_otimo = response[x][0].valor_OTIMO;
            this.valor_otimo_2 = response[x][0].valor_OTIMO_2;
            this.valor_otimo_3 = response[x][0].valor_OTIMO_3;
  ...
  gravar() {
    ...
    if (this.novo) {
      ...
      MOV_REG_PARAM_OPERACAO.param_INCORRETO_2 = this.param_incorreto_2;
      MOV_REG_PARAM_OPERACAO.param_INCORRETO_3 = this.param_incorreto_3;
      ...
      MOV_REG_PARAM_OPERACAO.valor_OTIMO_2 = this.valor_otimo_2;
      MOV_REG_PARAM_OPERACAO.valor_OTIMO_3 = this.valor_otimo_3;

...
export class GTDICTarefasComponent implements OnInit {
  ...
  selectedvalues = [];
  utz_cria;
  tipos_tarefas = [{ value: "", label: "Selecionar Tipo" }, { value: "R", label: "Reclamações Cliente" }, { value: "RF", label: "Reclamações Fornecedor" }, { value: "A", label: "Amostras" }, { value: "PA", label: "Planos de Ação" }, { value: "D", label: "Derrogações" }, { value: "M", label: "Manutenções" }, { value: "RE", label: "Reuniões" }]

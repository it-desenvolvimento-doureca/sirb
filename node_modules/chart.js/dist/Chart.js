...
module.exports = function(Chart) {
	...
	helpers.drawPoint = function(ctx, pointStyle, radius, x, y,textItem) {
		...
		if (textItem == 'Todos')pointStyle = 'star';
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.legend = {
		...
		onClick: function(e, legendItem) {
			...
			if(legendItem.text == "Todos"){
				if(meta.hidden){
					for(var z=1;z<ci.data.datasets.length;z++){
						var meta2 = ci.getDatasetMeta(z);
						meta2.hidden = true
					}
				}else{
					for(var z=1;z<ci.data.datasets.length;z++){
				...
				if(ci.data.datasets[0].label == 'Todos'){
					var count = 1;
					var meta2 = ci.getDatasetMeta(0);
					for(var t=1;t<ci.data.datasets.length;t++){
						var meta3 = ci.getDatasetMeta(t);
						if(meta3.hidden){
							count++;
						}
					}
					
					if(count == ci.data.datasets.length){
						meta2.hidden = true
					}else{
						meta2.hidden = false
					}						
		...
		draw: function() {
			...
			if (opts.display) {
				...
				var drawLegendBox = function(x, y, legendItem) {
					...
					if ((opts.labels && opts.labels.usePointStyle) || legendItem.text == 'Todos') {
						...
						if (legendItem.text == 'Todos') centerX = x + 32;
						// Draw pointStyle as legend symbol
						Chart.canvasHelpers.drawPoint(ctx, legendItem.pointStyle, radius, centerX, centerY,legendItem.text);
					} else {

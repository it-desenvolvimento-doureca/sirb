...
var Dialog = (function () {
    ...
    Dialog.prototype.show = function () {
        ...
        this.containerViewChild.nativeElement.style.zIndex = String(1016);
    ...
    Dialog.prototype.enableModality = function () {
        ...
        if (!this.mask) {
            ...
            this.mask.style.zIndex = String(parseInt(1015) - 1);
			var size = $(".wrapper").height();
			this.mask.style.height = size+"px";

    ...
    OverlayPanel.prototype.onAnimationStart = function (event) {
        switch (event.toState) {
            case 'visible':
				...
				var elemRect2 = this.target.getBoundingClientRect(),
				 offset2   = elemRect2.top - bodyRect.top;

				                //if (this.domHandler.getOffset(this.container).top < this.domHandler.getOffset(this.target).top) {
                if (offset < offset2) {
					var topVal = parseInt(this.container.style.top, 10);
					
                    this.container.style.top = (topVal - 20) + "px";

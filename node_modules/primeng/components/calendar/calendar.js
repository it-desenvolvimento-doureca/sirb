...
var Calendar = (function () {
    function Calendar(el, domHandler, renderer, cd) {
        ...
        this.stepSecond = 1;
		this.typeinput = "text";
		if(el.nativeElement.className.indexOf('timeinput') > -1) this.typeinput = "time";
    ...
    Calendar.prototype.showOverlay = function () {
        ...
        this.overlay.style.zIndex = String(1029);
...
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], Calendar.prototype, "typeinput", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)

...
var FileUpload = (function () {
	...
	FileUpload.prototype.fileImage = function (file) {
		var str= file.type;
		console.log(str)
		...
		}else if(str.toLowerCase().indexOf("doc") >= 0){
			return "assets/img/file-excel.png";
		}else{
